...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Nil500/Approval.txt/blob/main/Approval.txt"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/Captain.TaRikuL.420")
...
def notice():
	...
	runtxt("\n\033[0;97m  paid 2009 cloning Tool For Free Aproval Join Group ")
	os.system("xdg-open https://www.facebook.com/Captain.TaRikuL.420")
	runtxt("\033[0;97m Key Approval ke Lai WhatsApp  Jion Krein >> %s%s"%(G,basesplit))
	runtxt("\033[0;97m Key group admin ke inbox  coment krein")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Nil500/Approval.txt/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
